...
//
  ...
  define('MC_API_KEY', '92ee357d8342e936294b1873c87c95e2-us17'); // example: define('MC_API_KEY', '96f10bc8458cf6f4fa51c3cac045cd3d-us17');

  // mailchimp list id, for more info visit http://admin.mailchimp.com/lists/

  define('MC_LIST_ID', '23152987f6'); // example: define('MC_LIST_ID', 'c55a73208d');
